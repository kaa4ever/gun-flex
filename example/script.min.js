...
/***/ function(module, exports, __webpack_require__) {
	...
	var todo1 = gun.get('todos').set({ name: "Clean house" });
	var todo2 = gun.get('todos').set({ name: "Vacuum clean" });
	
	var person1 = gun.get('persons').put({ name: 'Kristian Kaa' });
	var person2 = gun.get('persons').put({ name: 'Lisbeth Knudsen' });
	
	todo1.path('assignees').set(person1);
	todo1.path('assignees').set(person2);
	
	gun.get('todos').map(function (todo, id) {
	  console.log('TODO', id, todo);
	});
	
	todo1.path('assignees').map(function (asignee) {
